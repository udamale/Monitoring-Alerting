...
echo "=============================="
echo " Installing Prometheus + Grafana + Alertmanager + Node Exporter on Amazon Linux"
echo "=============================="
...
receivers:
  - name: pagerduty
    pagerduty_configs:
      - routing_key: "c35d22ce43594c02d035af99b4c0e496"       #change the pagerduty Integration Key
        severity: "critical"
EOF
